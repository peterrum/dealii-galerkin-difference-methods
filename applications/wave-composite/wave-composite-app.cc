...
void
fill_parameters(Parameters<dim> &params, const std::string &simulation_name, const unsigned int &domain_index)
{
...
main(int argc, char **argv)
{
  ...
  if (dim == 1)
    {
      Parameters<1> params;
      fill_parameters(params, simulation_name, domain_index);
